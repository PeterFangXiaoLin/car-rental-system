...
(
    ...
    `idCardFrontImg`            varchar(255)                       NULL COMMENT '身份证正面照片URL',
    `idCardBackImg`             varchar(255)                       NULL COMMENT '身份证背面照片URL',
    `idCardVerifyStatus`        tinyint  DEFAULT 0                 NULL COMMENT '身份证认证状态：0-未实名，1-认证中，2-已认证，3-认证失败',
    `idCardVerifyTime`          datetime                           NULL COMMENT '身份证认证时间',
    `idCardRejectReason`        varchar(500)                       NULL COMMENT '身份证认证拒绝原因',
    `phoneNumber`               varchar(20)                        NULL COMMENT '手机号码',
    `email`                     varchar(100)                       NULL COMMENT '电子邮箱',
    `hasDriverLicense`          tinyint  DEFAULT 0                 NOT NULL COMMENT '是否有驾照：0-无，1-有',
    ...
    `driverLicenseFrontImg`     varchar(255)                       NULL COMMENT '驾照正面照片URL',
    `driverLicenseBackImg`      varchar(255)                       NULL COMMENT '驾照背面照片URL',
    `driverLicenseVerifyStatus` tinyint  DEFAULT 0                 NULL COMMENT '驾照认证状态：0-未认证，1-认证中，2-已认证，3-认证失败',
    ...
    INDEX `idx_hasDriverLicense` (`hasDriverLicense`),
    INDEX `idx_idCardVerifyStatus` (`idCardVerifyStatus`),
    INDEX `idx_driverLicenseVerifyStatus` (`driverLicenseVerifyStatus`),
...
(
    ...
    `userId`       bigint   NOT NULL COMMENT '用户ID',
    `verifyType`   tinyint  NOT NULL COMMENT '认证类型：1-身份证，2-驾驶证',
    `verifyStatus` tinyint  NOT NULL COMMENT '认证状态：0-未认证，1-认证中，2-已认证，3-认证失败',
    `verifyResult` tinyint           DEFAULT NULL COMMENT '认证结果：1-通过，2-拒绝',
    `rejectReason` varchar(500)      DEFAULT NULL COMMENT '拒绝原因',
